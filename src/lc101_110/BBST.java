...
public class BBST extends TreeNode //Balanced Binary Search Tree
{
	...
	public BBST(int x) {super(x);height=1;}
	private void setLeft(BBST nl){super.left=left=nl;}
	private void setRight(BBST nr){super.right=right=nr;}

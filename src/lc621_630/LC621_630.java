...
{
	int Length,	Deadline;
	MPair(int l, int d){Length=l;Deadline=d;}

	@Override
	public int compareTo(MPair o) {
		if (Deadline!=o.Deadline)
			return Deadline-o.Deadline;
		else return Length-o.Length;
	}
...
class Solution630 
{
	public int scheduleCourse(int[][] courses)
	{
		...
		PriorityQueue<MPair> pq=new PriorityQueue<MPair>(clen,
				(MPair sv1,MPair sv2)->sv2.Length-sv1.Length
				);
